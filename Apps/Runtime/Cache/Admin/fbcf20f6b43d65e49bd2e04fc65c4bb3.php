            ...
            <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        ...
                        <a class="btn btn-blue" href="/User/add_form">添加用户</a>
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <?php if(is_array($data)): foreach($data as $key=>$row): ?><tr>
                                ...
                                <td><?php echo $groups[$row['group_id']]; ?></td>
                                <td><?php echo ($row["last_ip"]); ?></td>
                                <td><?php echo (date("Y/m/d H:i",$row["last_time"])); ?></td>
                                <td>

                                    <a class="btn btn-sm btn-success" title="编辑" href="/User/edit_form/id/<?php echo ($row["id"]); ?>">
                                        <i class="fa-edit"></i>
                                    </a>

                                    <button class="btn btn-sm btn-red" title="删除" onclick="MSGBOX.show('是否真的要删除？',function(){
                                location.href='/User/del/id/<?php echo ($row["id"]); ?>'});">
                                        <i class="fa-remove"></i>
                                    </button>
                                </td>
