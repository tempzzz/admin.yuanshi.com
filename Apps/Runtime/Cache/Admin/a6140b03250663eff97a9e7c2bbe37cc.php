        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <form method="get" action="/Member/money">
                            UID： <input type="text" class="seachInput" name="uid"  value="" />&nbsp;&nbsp;<button class="btn btn-success " type="submit">Search</button></form><br /><br />
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <?php if(is_array($data)): foreach($data as $key=>$row): ?><tr>
                                    ...
                                    <td><?php echo ($row["bonus_earn"]); ?></td>
                                    <td><?php echo ($row["bonus_spend"]); ?></td>
                                    <td><a class="btn btn-blue btn-icon btn-icon-standalone btn-icon-standalone-right btn-xs" href="/Member/moneyview/uid/<?php echo ($row["uid"]); ?>">
                                        <i class="fa-search"></i>
                                        <span>流水</span>
                                    </a>&nbsp;&nbsp;<a class="btn btn-blue btn-icon btn-icon-standalone btn-icon-standalone-right btn-xs" href="/Member/bonusview/uid/<?php echo ($row["uid"]); ?>">
                                        <i class="fa-search"></i>
                                        <span>点劵</span>
                                    </a></td>
