...
<div class="page-title">
    ...
    <div class="title-env">
        <h1 class="title">用户代币查询</h1>
        <p class="description">流水</p>
    </div>
</div>
                    ...
                    <div class="col-sm-12">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <?php if(is_array($data)): foreach($data as $key=>$row): ?><tr>
                                    ...
                                    <td><?php echo ($row["money_earn"]); ?></td>
                                    <td><?php echo ($row["_money_earn"]); ?></td>
                                    <td><?php echo ($row["money_spend"]); ?></td>
                                    <td><?php echo ($row["_money_spend"]); ?></td>
                                    <td><?php echo ($row["bonus_earn"]); ?></td>
                                    <td><?php echo ($row["_bonus_earn"]); ?></td>
                                    <td><?php echo ($row["bonus_spend"]); ?></td>
                                    <td><?php echo ($row["_bonus_spend"]); ?></td>
                                    <td><?php echo (date("Y/m/d H:i",$row["ctime"])); ?></td>
                                    <td><a class="btn btn-blue btn-icon btn-icon-standalone btn-icon-standalone-right btn-xs"  href="/Member/orderview/id/<?php echo ($row["order_no"]); ?>"><i class="fa-search"></i>
                                        <span>查看</span></a></td>
