                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                            <?php if(is_array($cp)): foreach($cp as $key=>$rows): ?><tr>
                                    <td>
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                            <?php if(is_array($callback)): foreach($callback as $key=>$rows): ?><tr>
                                    <td>
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                            <?php if(is_array($mobile)): foreach($mobile as $key=>$rows): ?><tr>
                                    <td>
