    ...
    <div class="panel-body">
        ...
        <form role="form" id="form1" method="post" class="validate" action="/App/payment_edit" autocomplete="off" onsubmit="return checkData(this);">
            ...
            <div class="row col-margin">
                ...
                <?php $type = json_decode($data['type'],true); ?>
                <?php $payment_type = C("PAYMENT_TYPE"); ?>

                <?php if(is_array($payment_type)): foreach($payment_type as $key=>$rows): ?><div class="col-xs-2 form-block">
                    <label>
                        <input type="checkbox" name="payments[]" class="cbr cbr-<?php echo ($rows["color"]); ?>" value="<?php echo ($key); ?>"  <?php if($type[$key]) echo 'checked'; ?>/>
                        <?php echo ($rows["name"]); ?>
                    </label>
                    <br />
