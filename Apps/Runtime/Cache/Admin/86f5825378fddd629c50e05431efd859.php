            ...
            <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        ...
                        <a class="btn btn-blue" href="/Group/add_form">添加用户组</a>
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <?php if(is_array($data)): foreach($data as $key=>$row): ?><tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-sm btn-success" title="编辑" href="/Group/edit_form/id/<?php echo ($row["id"]); ?>">
                                            <i class="fa-edit"></i>
                                        </a>

                                        <button class="btn btn-sm btn-red" title="删除" onclick="MSGBOX.show('是否真的要删除？',function(){
                                location.href='/Group/del/id/<?php echo ($row["id"]); ?>'
                            });">
                                            <i class="fa-remove"></i>
                                        </button>
                                    </td>
